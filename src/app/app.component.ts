  ...
  constructor() {
    ...
    ngOnInit(): void {
      ...
      (function() {
         ...
         */
        const on = (type: string, el: string, listener: { (e: any): void; (e: any): void; (e: any): void; }, all = false) => {
          if (all) {
            select(el, all).forEach((e: { addEventListener: (arg0: string, arg1: { (e: any): void; (e: any): void; (e: any): void; }) => any; }) => e.addEventListener(type, listener))
          } else {
